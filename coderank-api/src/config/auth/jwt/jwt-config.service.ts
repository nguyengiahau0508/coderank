...
export class JwtConfigService {
  ...
  get emailVerificationSecret(): string {
    return this.configurationService.get<string>(
      ...
      'defaultEmailVerificationSecret',
    );
  }
  get emailVerificationExpiresIn(): string {
    return this.configurationService.get<string>(
      'jwtConfig.emailVerificationExpiresIn',
      'defaultEmailVerificationExpiresIn',
    );
  }
  ...
  get passwordResetSecret(): string {
    return this.configurationService.get<string>(
      ...
      'defaultPasswordResetSecret',
    );
  }

  get passwordResetExpiresIn(): string {
    return this.configurationService.get<string>(
      'jwtConfig.passwordResetExpiresIn',
      'defaultPasswordResetExpiresIn',
    );
  }
}
