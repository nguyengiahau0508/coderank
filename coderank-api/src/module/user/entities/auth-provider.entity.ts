...
export class AuthProviderEntity extends BaseEntity {
  ...
  @ApiEnumProperty('OAuth provider type', AuthProvidersEnum, 'AuthProvidersEnum', undefined, AuthProvidersEnum.Google)
  @Column({
    type: "enum",
  ...
  @ApiStringProperty('Unique identifier from the OAuth provider', '123456789012345678901', 255)
  ...
  @ApiUrlOptional('Avatar URL from OAuth provider', 'https://lh3.googleusercontent.com/a/default-user=s96-c')
