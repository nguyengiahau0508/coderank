...
export class CreateContestDto {
  ...
  @ApiPropertyOptional({
    description: 'Contest description (markdown/html)',
    example: 'This is a weekly coding contest',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiPropertyOptional({
    description: 'Whether the contest is public',
    example: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: 'Whether the contest is rated',
    example: false,
  })
  @IsOptional()
  @IsBoolean()
