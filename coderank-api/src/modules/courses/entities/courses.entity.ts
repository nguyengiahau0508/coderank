...
export class CoursesEntity extends BaseEntity {
  ...
  @ApiPropertyOptional({
    description: 'Maximum number of students (0 = unlimited)',
    example: 0,
  })
  ...
  @ApiPropertyOptional({
    ...
    example: 'algorithm,data-structure,graph',
  })
  @Column({ type: 'varchar', length: 500, nullable: true })
  tags?: string;
  ...
  @ApiPropertyOptional({
    description: 'What students will learn (JSON array)',
    example: '["Hiểu về cấu trúc dữ liệu","Giải thuật cơ bản"]',
  })
  @Column({ type: 'text', nullable: true, select: false })
  ...
  @ApiPropertyOptional({
    ...
    example: '["Lập trình cơ bản","Toán rời rạc"]',
  })
  @Column({ type: 'text', nullable: true, select: false })
