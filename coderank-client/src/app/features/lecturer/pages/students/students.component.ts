  ...
  template: `
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-500">View and manage your students</p>
      </div>
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-12">
        <div class="text-center max-w-md mx-auto">
          <div class="w-20 h-20 rounded-full bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center mx-auto mb-6">
            <i class="pi pi-users text-4xl text-blue-600"></i>
          </div>
...
export class LecturerStudentsComponent {}
